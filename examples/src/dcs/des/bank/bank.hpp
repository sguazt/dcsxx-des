...
class bank
{
	...
	private: typedef ::dcs::des::replications::engine<
							real_type,
							uint_type
					> des_engine_type;
	...
	//private: typedef ::dcs::des::base_statistic<real_type,uint_type> output_statistic_type;
	...
	private: typedef ::dcs::des::model::queue_M_M_k<
				...
				> queue_type;
	private: typedef bank<real_type,uint_type> self_type;


	private: static const uint_type default_replication_size = uint_type(1000);
	private: static const uint_type default_num_replications = uint_type(5);
	private: static const uint_type default_seed0 = uint_type(5489);
	private: static const real_type default_ci_level;/* = 0.95 */
	private: static const real_type default_relative_precision;/* = 0.04 */


	public: bank(uint_type num_tellers, real_type arr_rate, real_type svc_rate, bool verbose=false)
...
//		ptr_des_engine_->system_finalization_event_source().connect(
		...
		ptr_mean_response_time_ = ::dcs::des::make_analyzable_statistic(
					::dcs::des::mean_estimator<real_type,uint_type>(response_time_ci_level_),
					::dcs::des::null_transient_detector<real_type,uint_type>(),
					::dcs::des::replications::fixed_num_obs_replication_size_detector<real_type,uint_type>(repl_size_),
					//::dcs::des::replications::constant_num_replications_detector<real_type,uint_type>(num_repl_),
					::dcs::des::replications::banks2005_num_replications_detector<real_type,uint_type>(response_time_ci_level_, response_time_rel_prec_),
					*ptr_des_engine_,
		...
		ptr_q99_response_time_ = ::dcs::des::make_analyzable_statistic(
					::dcs::des::quantile_estimator<real_type,uint_type>(0.99, response_time_ci_level_),
					::dcs::des::null_transient_detector<real_type,uint_type>(),
					::dcs::des::replications::fixed_num_obs_replication_size_detector<real_type,uint_type>(repl_size_),
					//::dcs::des::replications::constant_num_replications_detector<real_type,uint_type>(num_repl_),
					::dcs::des::replications::banks2005_num_replications_detector<real_type,uint_type>(response_time_ci_level_, response_time_rel_prec_),
	...
	private: uint_type num_tellers_;
...
const RealT bank<RealT,UIntT>::default_ci_level = 0.95;

template <typename RealT, typename UIntT>
const RealT bank<RealT,UIntT>::default_relative_precision = 0.04;
