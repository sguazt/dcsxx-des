...
export srcdirs := .
export test_srcdirs := . dcs/des
export xmp_srcdirs := . dcs/des/bank dcs/des/qnet dcs/des/queue/mm1 dcs/des/simple_simulator
export libdirs :=
export test_libdirs :=
export xmp_libdirs :=
export incdirs := ./inc
export test_incdirs := $(testdir)/inc
...
# Macro BOOST_PARAMETER_MAX_ARITY should be set to 7 to make Boost.Signals2 and
# # Boost.Accumulators coexist
CXXFLAGS_common += -DBOOST_PARAMETER_MAX_ARITY=7
...
realclean: clean docs-clean
	...
	@$(CLEANER) inc/dcs/des/detail/boost.hpp
	@$(CLEANER) inc/dcs/des/detail/config.hpp
	@$(CLEANER) inc/dcs/des/detail/version.hpp
