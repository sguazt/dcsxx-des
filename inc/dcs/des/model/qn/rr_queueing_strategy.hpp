/**
 * \file dcs/des/model/qn/rr_queueing_strategy.hpp
 *
 * \brief Round-Robing (RR) queueing strategy.
 *
...
#ifndef DCS_DES_MODEL_QN_RR_QUEUEING_STRATEGY_HPP
#define DCS_DES_MODEL_QN_RR_QUEUEING_STRATEGY_HPP
...
class rr_queueing_strategy: public queueing_strategy<TraitsT>
{
	...
	public: rr_queueing_strategy()
	: base_type()
	{
	}


//	public: explicit rr_queueing_strategy(size_type capacity)
//	: base_type(capacity)
//	{
//	}
...
//		return this->infinite_capacity() || (this->size() < this->capacity());
	...
	private: void do_push(customer_pointer const& ptr_customer)
	{
		...
		DCS_ASSERT(
			...
			throw ::std::logic_error("[dcs::des::model::qn::rr_queueing_strategy::do_push] Queue is full.")
		);
	...
	private: void do_pop()
	{
		...
		DCS_ASSERT(
			!this->empty(),
			throw ::std::logic_error("[dcs::des::model::qn::rr_queueing_strategy::do_push] Queue is empty.")
		);
...
#endif // DCS_DES_MODEL_QN_RR_QUEUEING_STRATEGY_HPP
