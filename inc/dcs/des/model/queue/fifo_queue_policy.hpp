/**
 * \file dcs/des/model/queue/fifo_queue_policy.hpp
 *
...
#ifndef DCS_DES_MODEL_FIFO_QUEUE_POLICY_HPP
#define DCS_DES_MODEL_FIFO_QUEUE_POLICY_HPP
...
/**
 * \brief First-In First-Out (FIFO) queue policy.
 *
...
class fifo_queue_policy
{
	private: typedef ::std::queue<ValueT> container_type;
	...
	template <typename V>
	friend bool operator==(fifo_queue_policy<V> const& x, fifo_queue_policy<V> const& y)
	{
		return x.c_ == y.c_;
	}
...
#endif // DCS_DES_MODEL_FIFO_QUEUE_POLICY_HPP
