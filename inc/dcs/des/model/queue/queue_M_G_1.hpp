/**
 * \file dcs/des/model/queue/queue_M_G_1.hpp
 *
 * \brief Model for the M/G/1 queue.
 *
...
#ifndef DCS_DES_MODEL_QUEUE_M_G_1_HPP
#define DCS_DES_MODEL_QUEUE_M_G_1_HPP
					...
					>
{
	...
	/// A constructor.
	public: queue_M_G_1(real_type arrival_rate, service_distribution_type const& svctime_distr, random_generator_type& rng, ::boost::shared_ptr<des_engine_type> const& ptr_eng)
		: base_type(
...
#endif // DCS_DES_MODEL_QUEUE_M_G_1_HPP
