/**
 * \file dcs/des/model/queue/queue_M_M_k.hpp
 *
 * \brief Model for the M/M/k queue.
 *
...
#ifndef DCS_DES_MODEL_QUEUE_M_M_k_HPP
#define DCS_DES_MODEL_QUEUE_M_M_k_HPP
...
>
class queue_M_M_k: public open_queue<
							RealT,
					...
					>
{
	...
	/// A constructor.
	public: queue_M_M_k(real_type arrival_rate, real_type service_rate, std::size_t num_servers, random_generator_type& rng, ::boost::shared_ptr<des_engine_type> const& ptr_eng)
		: base_type(
...
#endif // DCS_DES_MODEL_QUEUE_M_M_k_HPP
